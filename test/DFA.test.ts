...
describe('DFA', ()  => {
    ...
    test('RegularExpression', ()=>{
        ...
        var regExp : RegularExpression = new RegularExpression().initWtihRegularExpression('a|<>')
        expect(regExp.test("")).toBe(true)
        ...
        var regExp : RegularExpression = new RegularExpression().initWtihRegularExpression('[1-3]')
        ...
        var regExp : RegularExpression = new RegularExpression().initWtihRegularExpression('[1-9][0-9]*|0')
        expect(regExp.test("1")).toBe(true)
        expect(regExp.test("2")).toBe(true)
        expect(regExp.test("3")).toBe(true)
        expect(regExp.test("0")).toBe(true)
        ...
        var regExp : RegularExpression = new RegularExpression().initWtihRegularExpression('(a|b)*c')
        ...
        var regExp : RegularExpression = new RegularExpression().initWtihRegularExpression('((a|b)*c)|((a|b)*d)')
        expect(regExp.test("\\")).toBe(false)
        expect(regExp.test("\\\\")).toBe(false)
        expect(regExp.test("2")).toBe(false)
        expect(regExp.test("c")).toBe(true)
        ...
        var regExp : RegularExpression = new RegularExpression().initWtihRegularExpression(`"*"{4,}`)
        expect(regExp.test("\\")).toBe(false)
        expect(regExp.test("\\\\")).toBe(false)
        expect(regExp.test("(")).toBe(false)
        expect(regExp.test("*")).toBe(false)
        ...
        // var regExp : RegularExpression = new RegularExpression().initWtihRegularExpression('[^*_\\-\\+\\>\\#\\`\\:\\/\\"\\(\\)\\[\\]\\!\\^ \\t\\n]+')
        var regExp : RegularExpression = new RegularExpression().initWtihRegularExpression('[^\\[\\^]+')
        expect(regExp.test("a")).toBe(true)
        expect(regExp.test("^")).toBe(false)
        expect(regExp.test("[")).toBe(false)

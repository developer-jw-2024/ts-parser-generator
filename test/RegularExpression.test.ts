...
describe('RegularExpression', ()  => {
    ...
    test('getFollowTermIndex', () => {
        ...
        expect(getEndTermIndex(toRegularExpressionChars('<>'), 0)).toEqual(0);
        expect(getEndTermIndex(toRegularExpressionChars('<>'), 1)).toEqual(-1);
    ...
    test("buildRegularExpressionTree", () => {
        ...
        expect(tree.subtrees[1].subtrees.length).toEqual(2)
        expect(tree.subtrees[1].subtrees[0].operation).toEqual(RegularExpressionTreeOperation.CHAR)
        expect(tree.subtrees[1].subtrees[0].actualChars).toEqual(['b'])
        expect(tree.subtrees[1].subtrees[1].operation).toEqual(RegularExpressionTreeOperation.CHAR)
        expect(tree.subtrees[1].subtrees[1].actualChars).toEqual(['c'])
        ...
        expect(tree.subtrees.length).toEqual(3)
        expect(tree.subtrees[0].operation).toEqual(RegularExpressionTreeOperation.CHAR)
        expect(tree.subtrees[0].actualChars).toEqual(['x'])
        expect(tree.subtrees[1].operation).toEqual(RegularExpressionTreeOperation.CHAR)
        expect(tree.subtrees[1].actualChars).toEqual(['e'])
        expect(tree.subtrees[2].operation).toEqual(RegularExpressionTreeOperation.AND)
        expect(tree.subtrees[2].subtrees.length).toEqual(2)
        expect(tree.subtrees[2].subtrees[0].operation).toEqual(RegularExpressionTreeOperation.CHAR)
        expect(tree.subtrees[2].subtrees[0].actualChars).toEqual(['b'])
        expect(tree.subtrees[2].subtrees[1].operation).toEqual(RegularExpressionTreeOperation.CHAR)
        expect(tree.subtrees[2].subtrees[1].actualChars).toEqual(['c'])
        ...
        expect(tree.subtrees[3].actualChars).toEqual(['g'])
        ...
        expect(tree.operation).toEqual(RegularExpressionTreeOperation.OR)
        expect(tree.actualChars).toEqual([])
        expect(tree.subtrees.length).toEqual(6)
        expect(tree.subtrees[0].operation).toEqual(RegularExpressionTreeOperation.CHAR)
        expect(tree.subtrees[0].actualChars).toEqual(['x'])
        expect(tree.subtrees[1].operation).toEqual(RegularExpressionTreeOperation.CHAR)
        expect(tree.subtrees[1].actualChars).toEqual(['y'])
        expect(tree.subtrees[2].operation).toEqual(RegularExpressionTreeOperation.CHAR)
        expect(tree.subtrees[2].actualChars).toEqual(['z'])
        expect(tree.subtrees[3].operation).toEqual(RegularExpressionTreeOperation.CHAR)
        expect(tree.subtrees[3].actualChars).toEqual(['e'])
        expect(tree.subtrees[4].operation).toEqual(RegularExpressionTreeOperation.AND)
        expect(tree.subtrees[4].subtrees.length).toEqual(2)
        expect(tree.subtrees[4].subtrees[0].operation).toEqual(RegularExpressionTreeOperation.CHAR)
        expect(tree.subtrees[4].subtrees[0].actualChars).toEqual(['b'])
        expect(tree.subtrees[4].subtrees[1].operation).toEqual(RegularExpressionTreeOperation.CHAR)
        expect(tree.subtrees[4].subtrees[1].actualChars).toEqual(['c'])
        expect(tree.subtrees[5].operation).toEqual(RegularExpressionTreeOperation.CHAR)
        expect(tree.subtrees[5].actualChars).toEqual(['g'])
